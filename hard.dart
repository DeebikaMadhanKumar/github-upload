...
class Qn1hard extends StatefulWidget {
  @override
...
class _Qn1State extends State<Qn1hard> {
  Timer _timer1;
  int _start1 = 10;
  _Qn1State() {
    if (setted == false) {
        ...
        (Timer timer) => setState(() {
              ...
              if (_start1 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/b2', ModalRoute.withName('/a2'));
              }
            }));
  }
    ...
    _timer2 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start2 < 1 || setted == true) {
                ...
                print("time up2!!");
                Navigator.pushNamedAndRemoveUntil(
                    context, '/c2', ModalRoute.withName('/b2'));
              }
            }));
  }
    ...
    _timer1 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start1 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/d2', ModalRoute.withName('/c2'));
              }
            }));
  }
    ...
    _timer1 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start1 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/e2', ModalRoute.withName('/d2'));
              }
            }));
  }
    ...
    _timer5 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start5 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/f2', ModalRoute.withName('/e2'));
              }
            }));
  }
    ...
    _timer6 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start6 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/g2', ModalRoute.withName('/f2'));
              }
            }));
  }
    ...
    _timer7 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start7 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/h2', ModalRoute.withName('/g2'));
              }
            }));
  }
    ...
    _timer8 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start8 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/i2', ModalRoute.withName('/h2'));
              }
            }));
  }
    ...
    _timer9 = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start9 < 1 || setted == true) {
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, '/j2', ModalRoute.withName('/i2'));
              }
            }));
  }
    ...
    _timer = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start < 1 || setted == true) {
                ...
                setted = true;
                Navigator.pushNamedAndRemoveUntil(
                    context, '/k2', ModalRoute.withName('/j2'));
              }
            }));
  }
    ...
    _timer = new Timer.periodic(
        ...
        (Timer timer) => setState(() {
              ...
              if (_start < 1 || setted == true) {
                ...
                setted = true;
                Navigator.pushNamedAndRemoveUntil(
                    context, '/p', ModalRoute.withName('/k2'));
              }
              if (pushed == true) {
                timer.cancel();
                Navigator.pushNamedAndRemoveUntil(
                    context, '/a2', ModalRoute.withName('/k2'));
              }
            }));
  }
